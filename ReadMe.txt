...
About Dataset:
Context:
This dataset is a collection of basic but crucial stats of the English Premier League 2020-21 season. 
The dataset has all the players that played in the EPL and their standard stats such as Goals, Assists, xG, xA, Passes Attempted, Pass Accuracy and more! Do upvote if you like it!
...
xG (Number Of Goals)	Expected number of goals from the player in a match.
xA (Number Of Assists)	Expected number of assists from the player in a match.
